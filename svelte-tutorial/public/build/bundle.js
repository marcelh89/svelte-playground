...
var app = (function () {
    ...
    /* src/ContactCard.svelte generated by Svelte v3.55.1 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "alt", "");
    			add_location(img, file$1, 7, 12, 64);
    			add_location(div0, file$1, 6, 8, 46);
    			add_location(h1, file$1, 10, 12, 125);
    			add_location(h2, file$1, 11, 12, 156);
    			add_location(div1, file$1, 9, 8, 107);
    			add_location(header, file$1, 5, 4, 29);
    			add_location(p, file$1, 15, 8, 222);
    			add_location(div2, file$1, 14, 4, 208);
    			add_location(div3, file$1, 4, 0, 19);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 37, 0, 551);
    			add_location(button, file, 38, 0, 600);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 41, 0, 779);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
